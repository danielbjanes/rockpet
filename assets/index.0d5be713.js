...
function R() {
    for (var t = [], e = 0; e < k; e++) {
        var o = -150 + Math.round(Math.random() * 300),
...
function ee() { const e = new h().load("rock_texture.jpg"); return new Y({ map: e }) }
...
function re() {
    ...
    t.add(e, "Rock Weight").onChange(o => { k = o, a.clear(), R(), L() }), t.add(e, "Rock Name"), t.add(e, "Feed Rock"), t.add(e, "Walk Your Rock"), t.add(e, "Texture", ["nature_background.jpg", "desert.jpg", "snowy_background.jpg"]).onChange(o => { x(o) })
}
...
function j() { J(), X(), L(), $(), Q(), ne(), new h().load("default_background.jpg", function(e) { a.background = e }), x(), window.onresize = S }
const C = H();
